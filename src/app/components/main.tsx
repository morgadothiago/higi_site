...
const Main = () => {
  ...
  return (
    <div className="w-full h-[30rem] bg-cover bg-[#176481] bg-center flex items-center justify-center" style={{ backgroundImage: `url(${limpeza.src})` }} >
      <div className="sm: mx-10 sm:px-20 px-4 bg-[#176481] bg-opacity-30 rounded-lg p-12 flex flex-col items-center justify-center shadow-lg transition-transform transform animate-bounce">
