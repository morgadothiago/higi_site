...
const Main = () => {
  ...
  return (
    <section className="w-full min-h-[calc(100vh-4rem)] pt-16 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto">
        <div className="w-full h-[30rem] bg-cover bg-[#176481] bg-center flex items-center justify-center" style={{ backgroundImage: `url(${limpeza.src})` }} >
          <div className="sm: mx-10 sm:px-20 px-4 bg-[#176481] bg-opacity-30 rounded-lg p-12 flex flex-col items-center justify-center shadow-lg transition-transform transform animate-bounce mt-20">
